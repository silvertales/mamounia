...
app.secret_key = os.environ.get('SECRET_KEY', 'babayaga711')
app.debug = os.environ.get('FLASK_DEBUG', '0') == '1'
 
# ---------- Database helpers ----------
# DATABASE_URL is set in Vercel environment variables (your Neon connection string)
DATABASE_URL = os.environ.get('DATABASE_URL', 'postgresql://neondb_owner:npg_dDRh6z4kGCso@ep-super-feather-a2zi96j2-pooler.eu-central-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require')
